...
const (
	...
	skcfCustomEndpointFlag            = "skcf-custom-endpoint"
...
func NewCmd(p *print.Printer) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if model.SKCFCustomEndpoint {
				viper.Set(config.SKCFCustomEndpointKey, "")
			}
...
func configureFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(skcfCustomEndpointFlag, false, "SKCF API base URL. If unset, uses the default base URL")
...
func parseInput(p *print.Printer, cmd *cobra.Command) *inputModel {
	model := inputModel{
		...
		SKCFCustomEndpoint:            flags.FlagToBoolValue(p, cmd, skcfCustomEndpointFlag),
