...
var testPayload = skcf.CreateOrUpdateClusterPayload{}
...
func fixtureRequest(mods ...func(request *skcf.ApiCreateOrUpdateClusterRequest)) skcf.ApiCreateOrUpdateClusterRequest {
...
func TestBuildRequest(t *testing.T) {
	tests := []struct {
		description     string
		model           *inputModel
		expectedRequest skcf.ApiCreateOrUpdateClusterRequest
		isValid         bool
	}{
		{
			description:     "base",
